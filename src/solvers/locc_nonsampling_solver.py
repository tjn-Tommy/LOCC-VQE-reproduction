...
class NonSampleSolver(BaseSolver):
    def __init__(self, config):
        ...
        self.quantum_net = partial(paper_syndrome_circuit, n_bits=self.num_qubits)
    ...
    def train(self, iteration, perturb):
        ...
        init_parameters_vmap = jax.vmap(init_reduced_syndrome_correction_parameters, in_axes=(None, 0), out_axes=0)
